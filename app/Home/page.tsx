  ...
  return (
    <div className="relative mx-auto my-10 flex max-w-7xl flex-col items-center justify-center">
      ...
      <div className="px-4 py-10 md:py-20">
        ...
        >
          <button className="w-60 cursor-pointer transform rounded-lg bg-gradient-to-r from-blue-500 to-green-500 px-6 py-2 font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:from-blue-600 hover:to-green-600 flex items-center justify-center gap-2">
